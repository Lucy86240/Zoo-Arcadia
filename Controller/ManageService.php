...
if($_SERVER['REQUEST_URI']=='/Controller/ManageService.php'){
    ...
    function allServices(bool $description=true){
        ...
        foreach($servicesObject as $serviceObject){ 
            $service = array(
                ...
                "icon" => $serviceObject->getIcon(),
                "photo" => $serviceObject->getPhoto(),
            );
            if($description == true){
    ...
    function updateService($service){
        ...
        if(isset($_POST[$nameButtonValid]) && $_POST[$nameButtonValid]!=null){
            ...
            $description = null;
            if(isset($_POST[$nameDescription]) && $_POST[$nameDescription]!=null){
            ...
            if(isset($_FILES[$namePhoto])){
                if(validImg($_FILES[$namePhoto]) == null){
                    ...
                    if($id_image !=0) updateImageRequest($id_image, $path, $descImg, $portrait);
                }
            }
