...
//filtrage des comptes
    ...
    /**
     * affichage seulement les comptes répondant au filtre role
     */
    ...
    //quand on clic sur une checkbox d'un role
    for(let i=0; i<rolesCheckbox.length;i++){
        rolesCheckbox[i].addEventListener('click',()=>{
            ...
            //on affiche les bons utilisateurs
            displayAccountRole()
            //on réinitialise le barre de recherche de mail
            searchMail.value = "";
        })
    }

    /**
     * on recherche les utilisateurs répondant à la saisie
     * @param {*} searchInput : barre de recherche
     * @param {*} list : element à afficher ou non suivant recherche
     * @param {*} element : classe des éléments permettant la comparaison avec la barre de recherche
     */
...
//création du popup pour bloquer un utilisateur
...
// débloquer un compte
    /**
     * Créer le popup pour débloquer un utilisateur
     * @param {*} mail : mail de l'utilisteur
