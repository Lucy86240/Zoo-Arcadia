<?php if($_SERVER['REQUEST_URI']=='/View/pages/animal/allAnimals.php'){
    ...
    <section class="allAnimals">
        ...
        <section id="animalSelected">
            <?php 
            if((isset($_POST['animalSelected']) && animalExistById($_POST['animalSelected'])) ||
                (isset($_SESSION['allAnimals_animalSelected']) && animalExistById($_SESSION['allAnimals_animalSelected']))){
