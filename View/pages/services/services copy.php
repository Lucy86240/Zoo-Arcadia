        ...
        foreach($services as $service){?>
            ...
            <!-- icones permettant la modification / suppression d'un service (seulement pour admin et employés)-->
                ...
                <div class = "box-backOffice">
                    <div class="bgc-img-box">
                        <img class="img-box editServiceD" src="View/assets/img/general/icons/edit.svg" alt="Modifier service">
                    </div>
                    <?php if(authorize(['Administrateur.rice'])){ ?>
                        <!-- bouton de suppression seulement pour admin-->
                        <a href="#" class="bgc-img-box iconDelete">
            ...
            <div class="service service-mobile">
                ...
                <div class = "box-backOffice">
                    ...
                    <?php if(authorize(['Administrateur.rice'])){ ?>
                    <div class="bgc-img-box popupMobile">
                        <img class="img-box" src="View/assets/img/general/icons/delete.svg" alt="Supprimer service">
                    </div>
                    <?php } ?>
                </div>
