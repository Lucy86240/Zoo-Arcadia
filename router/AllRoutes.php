...
$allRoutes = array(
    ...
    new Route('rapport_medicaux_animal',true,'Rapport Médicaux','View/pages/medicalReports/medicalReportsAnimal.php',['Vétérinaire','administrateur.trice'],'Controller/ManageMedicalReports.php'),
